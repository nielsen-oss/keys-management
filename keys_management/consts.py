...
KEY_CHANGED_INFO_MESSAGE = 'the key "{}" is changed from {} to {} registered callbacks will be executed'
KEY_CHANGED_DEBUG_MESSAGE = 'the key "{}" is changed, registered callbacks will be executed'
